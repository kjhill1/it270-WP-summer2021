...
$kale_pages_show_thumbnail = kale_get_option( 'kale_pages_show_thumbnail' );

$kale_pages_featured_image_show = 'Default';
$kale_page_meta = get_post_meta(get_the_ID(),'_page_options_meta',TRUE);
if($kale_page_meta && $kale_pages_show_thumbnail) {
...
<div class="row two-columns">
    ...
    <!-- /Main Column -->
    <aside>
        <?php dynamic_sidebar( 'sidebar-project-1' ); ?>
